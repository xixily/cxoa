...
public class BarCode128C {
	...
	private static Logger log = Logger.getLogger(BarCode128C.class);
	...
	*/
	 ...
	 */
	public static void getCode128CPicture(String barCode,int height, String path) {
		String barString = getCode(barCode);
		drawCode128C(barString, height, path);
	}
