...
public interface HetongService_mysql {
	//用户列表
	...
	public PContract getContract(int id);
	...
	//发货情况
	public Map<String, Object> findFahuo(PFahuo pfahuo, int isExport);
	
	public PFahuo getPFahuo(int id);
