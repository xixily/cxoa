...
<span class="btn-separator"></span>
<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true" onclick="">维护工作日表</a>
<span class="btn-separator"></span>
...
<div id="menu_kaoqin_databaseRefact" style="width:160px;">
	<div data-options="iconCls:'icon-edit'" onclick="">1、维护工作日表</div>
    <div data-options="iconCls:'icon-databse_edit'" onclick="">2、批量生成当月考勤</div>
</div>