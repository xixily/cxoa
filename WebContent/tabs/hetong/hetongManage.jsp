...
<!-- 合同管理 -->
<div id="tab_hetongManage" class="easyui-panel" title="合同管理" style="padding: 10px;overflow: hidden"	data-options="iconCls:'icon-edit',closable:true">
<!-- 组合查询form表单 -->
	<div id="form_hetongManage" title="组合查询" class="easyui-panel"
		data-options="iconCls:'icon-search',href:'${pageContext.request.contextPath}/queryForm/htManage_queryform.jsp',tools:[
				{iconCls:'icon-reload',handler:function(){$('#form_hetongManage').panel('open').panel('refresh')}}]"
