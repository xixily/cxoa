		...
		<table id="datagrid_monthWages" class="easyui-datagrid" style="width: 100%;height:510px;"
			...
			<thead>
				<tr>
					...
					<th data-options="field:'chuqinDay',width:60,sortable:true">出勤天数</th>
					<th data-options="field:'zhuanzhengChaeDay',width:60,sortable:true">转正差额天数</th>	
					<th data-options="field:'salary',width:70,sortable:true">工资总额</th>
					<th data-options="field:'selfTax',width:70,sortable:true">个人所得税</th>
					...
					<th data-options="field:'bufaSalary',width:60,sortable:true">补发工资</th>
					...
					<th data-options="field:'secrecySubsidy',width:60,sortable:true">保密补贴</th>
					<th data-options="field:'communicationSubsidy',width:60,sortable:true">通讯补贴</th>
					<th data-options="field:'lunchSubsidy',width:60,sortable:true">午餐补贴</th>
					<th data-options="field:'shiJiaHour',width:60,sortable:true">事假时数</th>
					<th data-options="field:'bingJiaHour',width:60,sortable:true">病假时数</th>
					<th data-options="field:'kuangGongHour',width:60,sortable:true">旷工时数</th>
					<th data-options="field:'chidaoYingkouDay',width:60,sortable:true">迟到应扣天数</th>
					<!-- <th data-options="field:'hunJiaDay',width:60,sortable:true">婚假天数</th> -->
					...
					<th data-options="field:'kaoQinremarks',width:100,sortable:true">历史工资</th>
				</tr>
			</thead>
		</table>
